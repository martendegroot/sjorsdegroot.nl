    ...
    <>
      ...
      <div className="absolute bottom-0 right-0 w-full h-full isolate overflow-hidden -z-10">
        <Image
          ...
          className="absolute bottom-0 h-[110vh] xl:h-full object-cover lg:object-contain object-[calc(20em_-_40vh)_20vh] sm:object-[40vw_20vh] xl:object-[right_10vh] 2xl:object-[calc(50%_+_400px)_5vh] 2xl:left-[15%]"
          quality={100}
        />
      </div>
    </>
